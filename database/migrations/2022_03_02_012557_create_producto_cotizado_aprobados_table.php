...
class CreateProductoCotizadoAprobadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('producto_cotizado_aprobados', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('producto_cotizado_aprobados');
    }
}
