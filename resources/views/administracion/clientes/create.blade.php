            ...
            <div class="card-header">
                <div class="row d-flex">
                    <div class="col-10 texto-header">
                        <h5>Nuevo cliente</h5>
                        <p>Un nuevo cliente, corresponde a un nuevo punto de venta, independientemente de los puntos de entrega. Ingrese los valores correspondientes a un nuevo cliente. Si desea agregar un nuevo punto de entrega, vaya a la sección <a href="{{route('administracion.clientes.agregarPuntoEntrega')}}">Cliente/Agregar puntos de entrega</a>.</p>
                    </div>
