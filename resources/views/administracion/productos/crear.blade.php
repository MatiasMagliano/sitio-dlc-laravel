                ...
                <div class="pl-lg-4">
                    ...
                    <div class="form-row d-flex">
                        <div class="form-group col-md-4 mb-3">
                            <label for="precioCompra" class="label">{{ __('formularios.batch_price') }}</label>
                            <input type="text" name="precioCompra" id="precioCompra" class="form-control @error('precioCompra') is-invalid @enderror" value="{{ old('precioCompra') }}">
                            @error('precioCompra')<div class="invalid-feedback">{{$message}}</div>@enderror
                        </div>
