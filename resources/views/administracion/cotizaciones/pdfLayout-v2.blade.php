    ...
    <body>
                                ...
                                <td style="text-align: left; width: 35%;border-top-style:none">
                                    <ul class="list-group">
                                        <li class="list-group-item list-data-header">
                                            {{ $cotizacion->razon_social }}</li>
                                        <li class="list-group-item list-data-header">{{ $cotizacion->lugar_entrega }}
                                        </li>
                                        <li class="list-group-item list-data-header">
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: left; width: 18%;border-top-style:none">
                                    <ul class="list-group">
                                        <li class="list-group-item list-data-header">{{ $cotizacion->cliente_id }}</li>
                                        <li class="list-group-item list-data-header">{{ $cotizacion->afip }}</li>
                                        <li class="list-group-item list-data-header">{{ $cotizacion->telefono }}
                                        </li>
                                        <li class="list-group-item list-data-header"></li>
                                        <li class="list-group-item list-data-header"></li>
                                    </ul>
        ...
        <div class="container" style="width:100%;padding: 0;font-size:11px;">
            <table class="table table-sm" style="">
                ...
                <tbody>
                    @php 
                        $i = 0; /*variable contadora del Nº Orden*/
                        $total = 0;
                    @endphp
                    @foreach ($lineas as $linea)
                        ...
                        @php $total = $total + $linea->total @endphp
                    @endforeach
                    <br>
        ...
        <section class="container mt-3">
            @php
                ...
                if (sizeof($totalarray) > 1) {
                    $letras = 'En letras: son ' . $montoLetras->format($totalarray[0]) . ' pesos, con ' . $montoLetras->format($totalarray[1]) . ' centavos.';
                } else {
                    $letras = 'En letras: son ' . $montoLetras->format($totalarray[0]) . ' pesos, con cero centavos.';
                }
            @endphp
